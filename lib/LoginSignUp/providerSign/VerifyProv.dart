...
class VerProv extends StatefulWidget {
  const VerProv({super.key});

  @override
  State<VerProv> createState() => _VerProvState();
}

class _VerProvState extends State<VerProv> {
  ...
  void initState() {
    ...
    super.initState();
    isVerified = true; /*FirebaseAuth.instance.currentUser!.emailVerified;*/
